...
/**
 * Adds the C4 library to the sidebar.
 */
Sidebar.prototype.addC4Palette = function(expand) {
	// Avoids having to bind all functions to "this"
	var sb = this;
	...
	this.addPaletteFunctions('c4', mxResources.get('c4'), expand || false, fns);
	this.setCurrentSearchEntryLibrary();
}
